...
let CryptoJS = {
    algo:{},
    lib:{WordArray:md5.lib.WordArray}
};
CryptoJS.algo = Object.assign(CryptoJS.algo, md5.algo,sha1.algo,sha256.algo,sha512.algo,sha3.algo,ripemd160.algo);
// CryptoJS.algo = Object.assign(CryptoJS.algo, );
// CryptoJS.algo = Object.assign(CryptoJS.algo, sha256.algo);
// CryptoJS.algo = Object.assign(CryptoJS.algo, sha512.algo);
// CryptoJS.algo = Object.assign(CryptoJS.algo, sha3.algo);
// CryptoJS.algo = Object.assign(CryptoJS.algo, ripemd160.algo);
...
export function workerImpl(enabledAlgorithms,data, pos, file,crc32intermediate) {
