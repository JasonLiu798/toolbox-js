<template>
<div class="htmlchar">
<table class="el-table__body toolTable" width="50%" cellspacing="0" cellpadding="0">
    <tr>
...
<table class="el-table__body toolTable table" width="100%" cellspacing="0" cellpadding="0">
